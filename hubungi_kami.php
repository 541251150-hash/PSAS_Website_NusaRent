            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center space-x-8">
                    ...
                    <div class="hidden md:flex items-center space-x-6 pt-2">
                        ...
                        <a href="hubungi_kami.php" class="bg-blue-500/50 px-3 py-1 rounded text-sm font-medium transition">Hubungi Kami</a>
    ...
    <section class="py-12 bg-white border-t border-gray-200">
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <div class="flex justify-center gap-6">
                <a href="#" class="w-14 h-14 bg-[#3b5998] text-white rounded-full flex items-center justify-center text-2xl shadow hover:-translate-y-2 transition duration-300" title="Facebook">
                ...
                <a href="#" class="w-14 h-14 bg-[#000000] text-white rounded-full flex items-center justify-center text-2xl shadow hover:-translate-y-2 transition duration-300" title="X (Twitter)">
